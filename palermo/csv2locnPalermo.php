 ...
 * Create the handles
*/
$assets=fopen('confiscatedAssetsPalermoAssets.owl','w+') or die('Unable to create file');
$locations=fopen('confiscatedAssetsPalermoLocations.owl','w+') or die('Unable to create file');
$coordinates=fopen('confiscatedAssetsPalermoCoordinates.owl','w+') or die('Unable to create file');
$all=fopen('confiscatedAssetsPalermoAll.owl','w+') or die('Unable to create file');
$log=fopen('confiscatedAssetsPalermoLog.txt','w+') or die('Unable to create file');

/******************************************************
 * Print headers.
*/
fwrite($assets, file_get_contents('confiscatedAssetsPalermo_preamble.owl.part'));
fwrite($locations, file_get_contents('confiscatedAssetsPalermoLocations_preamble.owl.part'));
fwrite($coordinates, file_get_contents('confiscatedAssetsPalermoCoordinates_preamble.owl.part'));
fwrite($all, file_get_contents('confiscatedAssetsPalermoAll_preamble.owl.part'));
